  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="mt-4 row mx-24 md:mx-56 lg:mx-96">
        ...
        <input onChange={(e) => setAmount(e.target.value)} type="number" className="appearance-none mt-4 block w-full border border-white-600 hover:border-white-700 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" style={{ backgroundColor: 'transparent', color: 'white' }} />
      </div>
